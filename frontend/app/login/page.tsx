  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-graphite-900 p-6">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(63,214,224,1) 1px, transparent 1px), linear-gradient(90deg, rgba(63,214,224,1) 1px, transparent 1px)",
      ...
      <div className="relative w-full max-w-[380px]">
        ...
        <div className="rounded-lg border border-graphite-700 bg-graphite-850 p-6 shadow-panel">
          <h1 className="mb-5 text-[15px] font-semibold text-white">Sign in</h1>
